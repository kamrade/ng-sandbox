...
import { PushCardComponent } from './push-card/push-card.component';
...
@NgModule({
  ...
  declarations: [PatternsAndTechnicsPageComponent, ChangeDetectionStrategiesComponent, StudentCardComponent, CourseCardComponent, PushCardComponent ]
})
